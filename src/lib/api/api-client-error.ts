...
const API_ERROR_MESSAGES: Record<string, string> = {
  ...
  ml_item_sku_failed: "Não foi possível buscar o SKU do anúncio no Mercado Livre.",
  product_sku_sync_failed: "Não foi possível sincronizar o SKU com o Mercado Livre.",
  products_sku_sync_failed: "Não foi possível sincronizar os SKUs com o Mercado Livre.",

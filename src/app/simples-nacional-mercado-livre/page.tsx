    ...
    <div className="marketing-landing flex min-h-full flex-1 flex-col">
      ...
      <main id="conteudo">
        ...
        <MarketingSection
          ...
          lead="No Simples Nacional você informa a alíquota efetiva do DAS em Configurações — o painel usa esse número para calcular margem e precificação de cada anúncio, sem pedir ICMS, ST ou monofásico, que não se aplicam a esse regime."
        >
          <DemoTributario />
